...
cat > /home/user/university-portal/frontend/src/pages/admin/AdminTeachers.jsx << 'TEACHERS'
...
cat > /home/user/university-portal/frontend/src/pages/admin/AdminSubjects.jsx << 'SUBJECTS'
import { useEffect, useState } from 'react';
...
echo "Core admin pages created successfully"
